  ...
  <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
    ...
    <form action="/contact" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
      ...
      <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
        <div>
          <label for="full-name" class="block text-sm/6 font-semibold text-gray-900">First name</label>
          <div class="mt-2.5">
            <input id="full-name" type="text" name="full-name" autocomplete="given-name"
              class="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600" required />
          </div>
        </div>
        ...
        <div class="sm:col-span-2">
          ...
          <div class="mt-2.5">
            <textarea id="message" name="message" rows="4"
              class="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600" required></textarea>
          </div>
        </div>
